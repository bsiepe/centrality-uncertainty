...
min_val <- min(df_estimates_scaled$Density_Point_Estimate, df_estimates_scaled$Outstrength_Point_Estimate)
max_val <- max(df_estimates_scaled$Density_Point_Estimate, df_estimates_scaled$Outstrength_Point_Estimate)
