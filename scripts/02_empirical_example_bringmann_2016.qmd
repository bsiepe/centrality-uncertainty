...
An additional advantage of Bayesian inference is the use of posterior predictive simulations, where we can compare predictive simulations from the posterior with the true observed data patterns. 
```{r bmlvar-postpred}
