...
df_regression <- readRDS(here("output/empirical_example/regression_empirical_example.RDS"))
```
...
outstrength_dist <- df_outstrength |> 
  ...
  ggdist::geom_dots(scale = 0.9, stackratio = 0.2,  layout = "swarm", linewidth = .3)+
...
df_density |> 
  ...
  theme(legend.position = "none") + 
  scale_fill_manual(values = ggokabeito::palette_okabe_ito(c(5,1,3,4)))
```
