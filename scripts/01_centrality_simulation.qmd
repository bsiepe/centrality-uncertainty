...
sim_analyse <- function(condition, dat, fixed_objects = NULL){
  ...
  stan_data <- list(
    ...
    reg_cent_type = array(rep(c(1L, 2L, 3L), each = 3L), dim = 9L),  # each measure x 3 effect sizes
    sparsity = 2,
...
We further combine the results  after fixing sigma: 

```{r}
cond14_het <- readRDS(here::here("output", "rev1_fixed_sigma", "sim_full_rev1_cond14_fixed_sigma.rds"))
cond23_het <- readRDS(here::here("output", "rev1_fixed_sigma", "sim_full_rev1_cond23_fixed_sigma.rds"))
...
saveRDS(sim_full_rev1_het, here::here("output", "sim_results_rev1_fixed_sigma.rds"))
