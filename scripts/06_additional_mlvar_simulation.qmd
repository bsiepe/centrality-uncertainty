...
# Background
This script contains the `SimDesign` code for an additional simulation investigation into `mlVAR`, where we try varios different things to investigate why mlVARs performance for random effects was poor. 
