...
```{r}
data.frame(
  est = sapply(res4$results[[1]]$mlvar$outstrength, function(x) x[1]),
  true = sapply(res4$results[[1]]$true_cent$outstrength, function(x) x[1])
) %>% 
