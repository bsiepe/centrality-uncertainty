...
if(isTRUE(use_rev1)){
  r3 <- readRDS("~/centrality-uncertainty/output/rev1_heterogeneous/sim_full_rev1_cond23_heterogeneous.rds-results_pc04669/results-row-2.rds")
} else {
...
ggsave_rev("est_variability_plot_heterogeneous.pdf", plot = est_variability_plot, 
       height = 6, width = 9,
       path = here::here("figures/"), device = "pdf")
