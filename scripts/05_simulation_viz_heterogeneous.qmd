...
subtitle: "Simulation Study Visualizations: Heterogeneous DGP"
author: 
 - name: Björn S. Siepe
...
This document contains code to reproduce the visualizations of the simulation study in the manuscript for the heterogeneous condition, which is only partly shown in the manuscript. 
...
revision <- "rev1"
use_rev1 <- TRUE
use_rev <- use_rev1  # alias expected by ggsave_rev() in 00_functions.R
```
...
```{r}
if(isTRUE(use_rev1)){
  sim_results <- readRDS(here::here("output", "sim_results_rev1_heterogeneous.rds"))
} else {
...
| Kept all output despite divergent transitions | Divergent transitions are a HMC sampling-efficiency warning and are distinct from non-convergence - we therefore do not perceive this as a true deviation, but rather a wording issue. The preregistered exclusion rule (exclude non-converged cases, base performance measures on converged cases only) was therefore not triggered.  |
...
ggsave_rev("plot_mostcentral_heterogeneous.pdf", plot_mostcentral, height = 6 * 1.1, width = 9 * 1.1,
...
ggsave_rev("plot_mostcentral_presentation_heterogeneous.pdf", plot_mostcentral_presentation, height = 6 * 1.2, width = 9 * 1.2,
       path = here::here("figures/"), device = "pdf")
...
ggsave_rev("plot_rankcor_heterogeneous.pdf", plot_rankcor, height = 12, width = 16,
       path = here::here("figures/"), device = "pdf")
...
ggsave_rev("plot_power_combined_heterogeneous.pdf", plot_power_combined, height = 16* 0.95, width = 16* 0.8,
       path = here::here("figures/"))
ggsave_rev("plot_power_combined_heterogeneous.svg", plot_power_combined, height = 16* 0.95, width = 16* 0.8,
...
This is an analogue to the simulation figure in the manuscript, but for the heterogeneous condition. 
...
ggsave_rev("plot_power_bias_outstrength_heterogeneous.pdf", 
...
ggsave_rev("plot_power_bias_outstrength_presentation_heterogeneous.pdf", 
...
ggsave_rev("plot_power_bias_strength_heterogeneous.pdf", 
       plot_power_bias_strength, height = 16* 0.95, width = 16* 0.8,
       path = here::here("figures/"))
ggsave_rev("plot_power_bias_strength_heterogeneous.svg", 
       plot_power_bias_strength, height = 16* 0.95, width = 16* 0.8,
...
## RMSE Plot
generate_regression_plots(sr_edit, "rmsereg", "RMSE", "plot_reg_rmse_combined_heterogeneous.pdf")

## Bias Plot
generate_regression_plots(sr_edit, "biasreg", "bias", "plot_reg_bias_combined_heterogeneous.pdf")
...
# if(isTRUE(use_rev1)){
#   r3 <- readRDS(here::here("output", "rev1_heterogeneous", "sim_full_rev1_cond23_heterogeneous.rds-results_pc04669", "results-row-2.rds"))
# } else {
...
#  
# # save plot as rds
# saveRDS(est_variability_plot, here::here("figures", "rev1", "est_variability_plot_heterogeneous.rds"))
...
#| fig-width: 9
#| fig-height: 9
est_variability_plot <- readRDS(here::here("figures", "rev1", "est_variability_plot_heterogeneous.rds"))
