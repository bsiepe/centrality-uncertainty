...
In this script, we will conduct some additional simulations for different levels of sparsity of the BmlVAR model. It mostly adapts code from `centrality_simulation.qmd`, but will only focus on some of the main outcomes 
