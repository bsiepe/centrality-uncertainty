...
ggsave("plot_mostcentral_mock.pdf", plot_mostcentral, height = 6 * 1.3, width = 9 * 1.3,
...
ggsave("plot_rankcor_mock.pdf", plot_rankcor, height = 12, width = 16,
       path = here::here("figures/"), device = "pdf")
...
ggsave("plot_power_combined_prelim.pdf", plot_power_combined, height = 16* 0.95, width = 16* 0.8,
...
![](figures/plot_reg_rmse_combined_prelim.pdf)
