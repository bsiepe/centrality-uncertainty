...
```{r}
if(isTRUE(use_rev1)){
  sim_results <- readRDS(here::here("output", "sim_results_rev1.rds"))
} else {
...
if(isTRUE(use_rev1)){
  sim_full_pre_resum <- readRDS(here("output", "sim_results_rev1.rds"))
} else {
...
if(isTRUE(use_rev1)){
  ...
  rename("Deprecated dplyr function" = "WARNING:  c(\"Warning in NULL : `funs()` was deprecated in dplyr 0.8.0.\", \"Warning in NULL : Please use a list of either functions or lambdas: \\n\\n  # Simple nam",
         ...
         "Exceeded maximum treedepth" = "WARNING:  Warning in NULL : There were 498 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 10. See\nhttps://mc-stan.org",
...
if(isTRUE(use_rev1)){
  r3 <- readRDS("~/centrality-uncertainty/output/rev1/sim_full_rev1_cond3.rds-results_pc04669/results-row.rds")
} else {
