...
We first need to compute it, as we didn't compute it in our initial simulation: 
...
if(isTRUE(use_rev)){
  r3 <- readRDS("~/centrality-uncertainty/output/rev1_fixed_sigma/sim_full_rev1_cond23_fixed_sigma.rds-results_pc04669/results-row-2.rds")
} else {
