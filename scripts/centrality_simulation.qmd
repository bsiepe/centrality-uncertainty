...
sim_analyse <- function(condition, dat, fixed_objects = NULL){
  ...
  if(isTRUE(gimme_var_only)){
    # TODO extract pcors from gimme_var
  }
...
SimClean()
saveRDS(sim_results, file = here("output/pilot_sim_results_clean_1604.RDS"))
...
```{r}
sim_results <- readRDS(here("output/pilot_sim_results_clean.RDS"))
