...
sim_analyse <- function(condition, dat, fixed_objects = NULL){
  ...
  # Obtain centralities
  dens_temp_blmvar <- ests_bmlvar$tempdens_est$median
  dens_cont_blmvar <- ests_bmlvar$contdens_est$median
