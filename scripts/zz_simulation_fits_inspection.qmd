...
```{r}
out_est <- sapply(sim_res_4$results[[1]]$bmlvar$outstrength, function(x) x[1])
covar_true <- sim_res_4$results[[1]]$covariate_out_strength[,4]
...
lm.beta(lm(covariate ~ outstrength, data = df_out))
```
