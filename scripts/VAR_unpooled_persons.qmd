---
title: "mlVAR Centrality Experiments"
format: html
---
...
# BS: TODO change away from N, this is misleading because this is  N = tp*n
# I didn't change it myself because this is your notation, but I suggest NR instead
N <- nrow(Y)
```
